<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\xampp\htdocs\houtai\public/../application/admin\view\article\add.html";i:1534219685;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\header.html";i:1526904358;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\footer.html";i:1528792740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="text" name="writer" id="writer" class="form-control" value="<?php echo $writer; ?>" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
