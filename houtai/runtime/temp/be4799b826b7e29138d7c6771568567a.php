...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">                                             
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('adminLog'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                 <select class="form-control m-b chosen-select" name="key" id='key'>
                                    <option value="0" <?php if($val == 0): ?>selected<?php endif; ?>>选择管理员</option>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr) {
        ...
        $.getJSON('<?php echo url("adminLog"); ?>', data,
