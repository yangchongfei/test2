<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"C:\xampp\htdocs\houtai\public/../application/admin\view\ad\ajax_ad_list.html";i:1528792739;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\status.html";i:1528792740;}*/ ?>
<?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr class="long-td">
        ...
        <td><img src="<?php echo $vo['images']; ?>" style="height: 30px" onerror="this.src='/static/admin/images/no_img.jpg'"/></td>
