<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\xampp\htdocs\houtai\public/../application/admin\view\articlecate\edit.html";i:1528792740;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\header.html";i:1526904358;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\footer.html";i:1528792740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="edit_cate" id="edit_cate" method="post" action="<?php echo url('edit'); ?>">
                    <input type="hidden" name="id" value="<?php echo $cate['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="orderby" type="text" class="form-control" name="orderby" value="<?php echo $cate['orderby']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
