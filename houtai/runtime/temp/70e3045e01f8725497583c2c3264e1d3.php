<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\xampp\htdocs\houtai\public/../application/admin\view\role\ajax_role_list.html";i:1528792740;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\status.html";i:1528792740;}*/ ?>
<?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <?php endswitch; ?>
        ...
        <?php else: ?>
            <td><a href="javascript:void(0);"><div ><span class="label label-info">开启</span></div></a></td>
        <?php endif; ?>
        <td><?php echo $vo['create_time']; ?></td>
        <td><?php echo $vo['update_time']; ?></td>
        <td>
            <?php if($vo['id'] != 1): ?>
                <a href="javascript:;" onclick="giveQx(<?php echo $vo['id']; ?>)" class="btn btn-info btn-outline btn-xs"><i class="fa fa-paste"></i> 权限分配</a>&nbsp;&nbsp;
