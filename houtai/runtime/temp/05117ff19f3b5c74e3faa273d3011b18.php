<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\xampp\htdocs\houtai\public/../application/admin\view\adminuser\edit.html";i:1528792740;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\header.html";i:1526904358;s:64:"C:\xampp\htdocs\houtai\application\admin\view\public\footer.html";i:1528792740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="userEdit" id="userEdit" method="post" action="<?php echo url('edit'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <img id="img_data" class="img-circle" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="<?php echo $user['portrait']; ?>" onerror="this.src='/static/admin/images/head_default.gif'"/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="password" type="password" class="form-control" name="password"  placeholder="输入修改密码,留空不修改">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var uploader = WebUploader.create({
        ...
        server: "<?php echo url('Upload/webUploaderImages',['folder' => 'face']); ?>",// 文件接收服务端。
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#username').val())){
                alert_msg.error('请输入用户名');
                return false;
            }
            
            if( '' == $.trim($('#groupid').val())){
                alert_msg.error('请选择用户角色');
                return false;
            }

            if( '' == $.trim($('#real_name').val())){
                alert_msg.error('请输入真实姓名');
                return false;
            }
        }
